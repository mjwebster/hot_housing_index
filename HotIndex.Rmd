...
index_all <-  read_csv('./output/index_all_output.csv')

pctstarter <-  read_csv('./output/pctstarter_output.csv')

index_moveup <-  read_csv('./output/index_moveup_output.csv')


index_starter <-  read_csv('./output/index_starter_output.csv')


inventory <-  read_csv('./output/inventory_output.csv')
